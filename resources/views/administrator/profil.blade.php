...
@section('content')
@section('title', 'Admin | Profil Management')

<div class="container-fluid pt-4 px-4">
    <div class="col-10 tableContent g-4">
        <div class="bg-light rounded h-100 p-4">
            <h2 class="mb-4 text-center">Pengaturan Profil</h2>
            <div class="table-responsive">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success ms-2 addButton" onclick="tampilkanModal('store')">Tambah profil</button>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col"><h6>#</h6></th>
                            <th scope="col"><h6>Jenis Layanan</h6></th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><p>{{ $profil->jenis_layanan }}</p></td>
                            <td><p>{{ $profil->deskripsi }}</p></td>
                            <td>
                                <button class="btn btn-sm btn-primary ButtonAksi" style="width: 60px;" onclick="tampilkanModal( 'update', {{ $profil->id }})"><p>Edit</p></button>
                                <form action="{{ route('profils.delete', ['id' => $profil->id]) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this profil?')">
                                    @csrf
                                    @method('delete')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('profils.storeOrUpdate') }}" method="post" enctype="multipart/form-data" id="editForm">
                    @csrf
                    <input type="hidden" name="formMethod" id="formMethod" value="">
                    <input type="hidden" name="profil_id" id="profil_id" value="">
                    <div class="mb-3">
