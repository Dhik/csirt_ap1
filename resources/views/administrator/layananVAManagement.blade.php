...
<div class="container-fluid pt-4 px-4">
    <div class="col-10 tableContent g-4">
        <div class="bg-light rounded h-100 p-4">
            <h2 class="mb-4 text-center">Pengaturan Layanan VA</h2>
            <div class="table-responsive">
                <div class="d-flex justify-content-between">
                    <button type="button" class="btn btn-success ms-2 addButton" onclick="tampilkanModal('store')">Tambah Layanan VA</button>
                </div>
                <table class="table">
                    <thead>
                        <tr>
                            <th scope="col"><h6>#</h6></th>
                            <th scope="col"><h6>Informasi Layanan VA</h6></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('vas.storeOrUpdate') }}" method="post" enctype="multipart/form-data" id="editForm">
                    ...
                    <div class="mb-3">
                        <label for="name">Informasi VA</label>
                        <input type="text" class="form-control" id="informasi_va" name="informasi_va">
                    </div>
