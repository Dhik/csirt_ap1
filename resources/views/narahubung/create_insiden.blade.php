            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <form action="{{ route('insiden.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="id_pelapor">ID Laporan</label>
                                <input type="text" class="form-control" id="id_pelapor" name="id_pelapor">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="waktu_insiden" name="waktu_insiden">
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="tipe" name="tipe">
                                    ...
                                    <option value="exploitation of weak configuration">Exploitation of Weak
                                        Configuration</option>
                                    <option value="social engineering and phising attacks">Social Engineering and
                                        Phishing Attacks</option>
                                    <option value="unintentional information exposure">Unintentional Information
                                        Exposure</option>
                                    <option value="spoofing or DNS poisoning">Spoofing or DNS Poisoning</option>
                                    <option value="Un-patched vulnerable software exploitation">Un-patched Vulnerable
                                        Software Exploitation</option>
                                    <option value="unauthorised system access">Unauthorised System Access</option>
                                    <option value="data theft">Data Theft</option>
                                    <option value="malware infection">Malware Infection</option>
                                    <option value="wireless access point exploitation">Wireless Access Point
                                        Exploitation</option>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="deskripsi_insiden" name="deskripsi_insiden" rows="4"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="screenshot_insiden">Screenshot Insiden</label>
                                <input type="file" class="form-control-file" id="screenshot_insiden" name="screenshot_insiden">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="status_insiden" name="status_insiden">
                            </div>
                            <div class="form-group">
