...
<body>
    ...
    <div class="sidebar pe-4 pb-3 styleNav">
        <nav class="navbar bg-light navbar-light">
            ...
            <div class="navbar-nav w-100">
                <a href="{{ route('pimpinan.dashboard') }}" class="nav-item nav-link menu">Dashboard</a>
            </div>
            <div class="navbar-nav w-100">
                <a href="{{ route('pimpinan.dataReport') }}" class="nav-item nav-link menu">Data Report</a>
            </div>
        </nav>
    </div>
    <!-- Sidebar End -->
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        ...
        <h2 class="navbar-brand mb-0 mx-4"><span style="font-weight: normal !important;">Content Management System CSIRT /</span> Pimpinan</h2>
