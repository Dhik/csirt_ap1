...
<body>
    ...
    <div class="sidebar pe-4 pb-3 styleNav">
        <nav class="navbar bg-light navbar-light">
            ...
            <a href="{{ route('superuser') }}" style="text-decoration: none;color: inherit;">
                <div class="d-flex align-items-center ms-4 mb-4">
    ...
    <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
        ...
        <h2 class="navbar-brand mb-0 mx-4"><span style="font-weight: normal !important;">Content Management System CSIRT /</span> Superuser</h2>
